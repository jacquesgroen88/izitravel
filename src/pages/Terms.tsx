                ...
                <div className="max-w-3xl mx-auto px-6 prose prose-gray">
                    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-10 space-y-8 text-gray-700 leading-relaxed">
                        ...
                        <div>
                            ...
                            <p>For any queries regarding these terms, please contact us at <a href="mailto:terrib@izitravel.co.za" className="text-primary-600 hover:underline">terrib@izitravel.co.za</a> or call <a href="tel:0608066589" className="text-primary-600 hover:underline">060 806 6589</a>.</p>
                        </div>
