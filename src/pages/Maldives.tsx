...
export default function Maldives() {
    ...
    return (
        <>
            <title>Maldives Holiday Packages from R35,000 pp | Izi Travel</title>
            <meta name="description" content="Book Maldives holiday packages from R35,000 per person, including return flights, overwater bungalows and resort transfers. Vaal Triangle travel experts. Free quote in minutes." />
            <link rel="canonical" href="https://izitravel.co.za/maldives" />
            <div className="bg-white">
                        ...
                        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
                            <div className="w-full lg:w-1/2 text-white">
                                <motion.h1 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}
                                    ...
                                    Maldives Holiday <br /><span className="text-primary-400 drop-shadow-lg">Packages</span>
                                </motion.h1>
                                ...
                                <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.15 }}
                                    className="text-base md:text-lg text-emerald-300 font-semibold mb-8 drop-shadow-xl">
                                    Packages from R35,000 per person — return flights &amp; accommodation included.
                                </motion.p>
                            ...
                            <motion.div id="quote" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6, delay: 0.3 }}
                                ...
                                <div className="bg-white rounded-2xl shadow-2xl p-8">
                                    ...
                                    <form className="space-y-4" onSubmit={handleSubmit}>
                                        ...
                                        <div>
                                            <p className="text-xs text-gray-500 mb-1 font-medium">Travel Dates</p>
                                            <div className="grid grid-cols-2 gap-2">
                                                <div>
                                                    <label className="text-xs text-gray-400 block mb-1">Departure</label>
                                                    <input type="date" name="departureDate" value={formData.departureDate} onChange={handleChange} className="input-field border-gray-200" />
                                                </div>
                                                <div>
                                                    <label className="text-xs text-gray-400 block mb-1">Return</label>
                                                    <input type="date" name="returnDate" value={formData.returnDate} onChange={handleChange} className="input-field border-gray-200" />
                                                </div>
                                            </div>
                                        </div>
                ...
                <section className="py-24 bg-white">
                    <div className="max-w-7xl mx-auto px-6">
                        <h2 className="text-4xl font-bold mb-16 text-center text-gray-900">Top Maldives Packages</h2>
