                        ...
                        >
                            <div className="bg-white rounded-2xl shadow-2xl overflow-hidden p-8">
                                ...
                                <form className="space-y-4" onSubmit={handleSubmit}>
                                    ...
                                    <select name="travellers" value={formData.travellers} onChange={handleChange} className="input-field appearance-none px-2"><option value="">Number of Travellers</option><option value="1">1</option><option value="2">2</option><option value="3+">3+</option></select>
                                    <select name="budget" value={formData.budget} onChange={handleChange} className="input-field appearance-none"><option value="">Budget per person (incl. flights)</option><option value="R12,000 - R18,000 pp">R12k - R18k pp</option><option value="R18,000 - R30,000 pp">R18k - R30k pp</option><option value="R30,000 - R50,000 pp">R30k - R50k pp</option><option value="R50,000+ pp">R50k+ pp</option></select>
