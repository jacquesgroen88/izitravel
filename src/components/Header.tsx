        ...
        <header className="fixed top-0 left-0 right-0 bg-white border-b border-gray-100 z-50 shadow-sm">
            <div className="max-w-7xl mx-auto w-full px-6 flex items-center justify-between h-[80px]">
                ...
                <div className="hidden md:flex items-center gap-4">
                    <a href="tel:0608066589" className="hidden lg:flex items-center gap-2 text-sm font-semibold text-gray-700 hover:text-primary-600 transition-colors">
                        <Phone className="w-4 h-4" /> 060 806 6589
                    </a>
            ...
            {mobileOpen && (
                <div className="md:hidden bg-white border-t border-gray-100 shadow-lg px-6 pb-6 pt-4 space-y-1 z-50">
                    ...
                    <div className="pt-3 border-t border-gray-100 flex flex-col gap-3">
                        <a href="tel:0608066589" className="flex items-center gap-2 text-sm font-semibold text-gray-700 px-4 py-3">
                            <Phone className="w-4 h-4 text-primary-600" /> 060 806 6589
                        </a>
